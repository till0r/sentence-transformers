...
class SentenceTransformer(nn.Sequential):
    ...
    def smart_batching_collate(self, batch):
        ...
        for idx in range(num_texts):
            tokenized = self.tokenizer.__call__(texts[idx], truncation=True, padding="max_length", max_length=1024, return_tensors="pt")
...
class ChunkSentenceTransformer(SentenceTransformer):
    """
    Loads or create a SentenceTransformer model, that can be used to map sentences / text to embeddings.
    ...
    def smart_batching_collate(self, batch):
        ...
        sentence_features = []
        for idx in range(num_texts):
            tokenized = self.tokenizer.__call__(texts[idx], truncation=True, padding=True, max_length=1024, return_tensors="pt")
            sentence_features.append(tokenized)
